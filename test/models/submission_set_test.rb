...
class SubmissionSetTest < ActiveSupport::TestCase
  ...
  test "should answer all non optional questions" do
    ...
    assert sset.save, "Failed to save submission set with missing submission to optional question"
  end
  ...
  test "can leave optional questions blank" do
    ...
    s.delete
    # save the submission set
    assert_not sset.save, "Failed to save submission set with missing submission to optional question"
  end

  test "should have submissions acessible through question.submissions" do
    sset = SubmissionSet.first
    ["TextQuestion", "NumberQuestion", "SingleChoiceQuestion"].each do |qtype|
      ...
      assert_equal submissionsA.count, submissionsB.count, "Submissions from question dont match submissions from submisson set"
    end
  end
end
