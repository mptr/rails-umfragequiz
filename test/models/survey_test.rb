...
class SurveyTest < ActiveSupport::TestCase
  def setup
    @survey = Survey.new(name: "TestSurvey", user: User.first, from_date: DateTime.yesterday, to_date: DateTime.tomorrow)
  end
  ...
  test "should have no questions associated" do
    assert_equal 0, @survey.questions.length, "new Survey already has associated questions"
  end
end
