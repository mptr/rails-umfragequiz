...
class NumberQuestionsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @number_question = number_questions(:one)
  end
  ...
  test "should create number_question" do
    assert_difference('NumberQuestion.count') do
      post number_questions_url, params: { number_question: {  } }, as: :json
    end
  ...
  test "should update number_question" do
    patch number_question_url(@number_question), params: { number_question: {  } }, as: :json
    assert_response 200
  end
