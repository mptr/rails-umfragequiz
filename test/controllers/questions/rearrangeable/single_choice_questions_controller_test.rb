...
class SingleChoiceQuestionsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @single_choice_question = single_choice_questions(:one)
  end
  ...
  test "should create single_choice_question" do
    assert_difference('SingleChoiceQuestion.count') do
      post single_choice_questions_url, params: { single_choice_question: {  } }, as: :json
    end
  ...
  test "should update single_choice_question" do
    patch single_choice_question_url(@single_choice_question), params: { single_choice_question: {  } }, as: :json
    assert_response 200
  end

  test "should destroy single_choice_question" do
    assert_difference('SingleChoiceQuestion.count', -1) do
      delete single_choice_question_url(@single_choice_question), as: :json
    end
