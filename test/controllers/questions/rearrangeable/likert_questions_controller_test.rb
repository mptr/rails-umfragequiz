...
class LikertQuestionsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @likert_question = likert_questions(:one)
  end
  ...
  test "should create likert_question" do
    assert_difference('LikertQuestion.count') do
      post likert_questions_url, params: { likert_question: {  } }, as: :json
    end
  ...
  test "should update likert_question" do
    patch likert_question_url(@likert_question), params: { likert_question: {  } }, as: :json
    assert_response 200
  end
