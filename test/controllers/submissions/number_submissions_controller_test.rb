...
class NumberSubmissionsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @number_submission = number_submissions(:one)
  end
  ...
  test "should create number_submission" do
    assert_difference('NumberSubmission.count') do
      post number_submissions_url, params: { number_submission: {  } }, as: :json
    end
  ...
  test "should update number_submission" do
    patch number_submission_url(@number_submission), params: { number_submission: {  } }, as: :json
    assert_response 200
  end
